...
output$genotype_metadata_dist_data_download <- downloadHandler(
  filename=reactive(download_filename(paste0(input$genotype_metadata_dist_plot_group, '__', input$genotype_metadata_dist_plot_group), '.csv')),
...
output$genotype_metadata_dist_plot_download <- downloadHandler(
  filename=reactive(download_filename(paste0(input$genotype_metadata_dist_plot_group, '__', input$genotype_metadata_dist_plot_group), '.pdf')),
